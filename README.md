...
<div align="center">
  ...
  <img src="docs/.images/Settings.jpg" height="350" alt="Settings" style="border-radius: 15px; margin: 5px;" />
  <img src="docs/.images/AdvancedSettings.jpg" height="350" alt="Advanced Settings" style="border-radius: 15px; margin: 5px;" />
  <img src="docs/.images/InstallationOptions.jpg" height="350" alt="Installation Options" style="border-radius: 15px; margin: 5px;" />
  <img src="docs/.images/SourceActions.png" height="350" alt="Source Actions" style="border-radius: 15px; margin: 5px;" />
  <img src="docs/.images/StockAppSourcesSelector.jpg" height="350" alt="Source Actions" style="border-radius: 15px; margin: 5px;" />
  <img src="docs/.images/FileSelectionInterface.jpg" height="350" alt="File Selection Interface" style="border-radius: 15px; margin: 5px;" />
  <img src="docs/.images/PatchSelectionInterface.jpg" height="350" alt="Patch Selection Interface" style="border-radius: 15px; margin: 5px;" />
  <img src="docs/.images/Apps.jpg" height="350" alt="Apps Actions" style="border-radius: 15px; margin: 5px;" />
</div>
...
* **🔍 Custom Search Engines:** Search for app versions using your preferred search provider ([DuckDuckGo](https://duckduckgo.com/), [Brave](https://search.brave.com/), [Google](https://www.google.com/), [Bing](https://www.bing.com/), [Yahoo](https://search.yahoo.com/), [Ecosia](https://www.ecosia.org/) or
  [Yandex](https://yandex.com/)).
* **📱 Installed App Picker:** Export third-party or system installed apps from your phone.
...
* **✂️ APK Optimization:** Remove unused native libraries, density resources, and languages from the patched app for a smaller APK size.
...
* **🧬 Morphe CLI Advanced Controls:** Fine-tune compiling with advanced options like `ContinueOnError` to keep patching even if a single patch fails, and toggle `bytecodeMode` (FULL, STRIP_SAFE, STRIP_FAST) for deeper low-level control.
* **🖼️ Launcher GUI:** Launch the full visual desktop interface directly via `SimplifyNext > sources > Launch GUI` using the underlying Morphe CLI wrapper.
* **🔔 Ongoing Patching Notifications:** Patching takes time; stay updated with background notifications, distinct audio tones upon success or failure, and an automatic copy of the patch log to your clipboard if it fails.
* **🦉 View Applied Patches:** See all patches currently applied to installed apps.
* **🐛 Capture Patched App Runtime Logs:** Capture real-time logs from your phone after a patched app crashes or misbehaves for easier debugging.
* **🚀 Launcher Shortcuts:** Quick access to SimplifyNext from your home screen using simplifyx launcher shortcuts.
...
* **🏗️ Build Patches:** Build patches directly from source code on your computer.
* **✨ More:** and many more... 🙃
