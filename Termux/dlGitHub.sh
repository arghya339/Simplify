...
dlGitHub() {
  ...
  if [ "$releases" == "latest" ]; then
    ...
    elif [ "$repo" == "FreeTubeAndroid" ] || [ "$repo" == "bundletool" ] || [ "$repo" == "twitter-apk" ] || [ "$repo" == "lawnchair" ] || [ "$repo" == "Nagram" ] || [ "$repo" == "revenge-xposed" ] || [ "$repo" == "io.github.vvb2060.callrecording" ] || [ "$repo" == "Gallery" ] || [ "$repo" == "PixelPlay" ] || [ "$repo" == "SmartTube" ] || [ "$repo" == "Android-DataBackup" ] || [ "$repo" == "com.wizpizz.reddidnt" ] || [ "$repo" == "MicroG-RE" ] || [ "$repo" == "dev.fzer0x.fucksolidexplorer" ] || [ "$repo" == "SilentRAR" ] || [ "$repo" == "xVIPHook" ] || [ "$repo" == "TeleVip-Lsposed" ]; then
    ...
    if [ "$repo" == "VancedMicroG" ] || [ "$repo" == "LSPatch" ] || [ "$repo" == "YTPro" ] || [ "$repo" == "cloudstream" ] || [ "$repo" == "revenge-xposed" ] || [ "$repo" == "io.github.vvb2060.callrecording" ] || [ "$owner" == "Droid-ify" ] || [ "$repo" == "Obtainium" ] || [ "$repo" == "Metrolist" ] || [ "$repo" == "Acode" ] || [ "$repo" == "PrivateDNSAndroid" ] || [ "$repo" == "RecordYou" ] || [ "$repo" == "android-appcachecleaner" ] || [ "$repo" == "com.wizpizz.reddidnt" ] || [ "$repo" == "cromite" ] || [ "$repo" == "nextdnsmanager" ] || [ "$repo" == "AmazeFileManager" ] || [ "$repo" == "MicroG-RE" ] || [ "$repo" == "dev.fzer0x.fucksolidexplorer" ] || [ "$repo" == "SilentRAR" ] || [ "$repo" == "TeleVip-Lsposed" ]; then
      assetsName=$(jq -r --arg regex "$regex" '.assets[] | select(.name | test($regex)) | .name' <<< "$ghApiResponseJson" | head -1)
      if [ "$repo" == "cloudstream" ] || [ "$repo" == "revenge-xposed" ] || [ "$repo" == "io.github.vvb2060.callrecording" ] || [ "$repo" == "PrivateDNSAndroid" ] || [ "$repo" == "RecordYou" ] || [ "$repo" == "android-appcachecleaner" ] || [ "$repo" == "nextdnsmanager" ] || [ "$repo" == "MicroG-RE" ] || [ "$repo" == "dev.fzer0x.fucksolidexplorer" ] || [ "$repo" == "SilentRAR" ] || [ "$repo" == "TeleVip-Lsposed" ]; then
    ...
    if [ "$repo" == "VancedMicroG" ] || [ "$repo" == "LSPatch" ] || [ "$repo" == "YTPro" ] || [ "$repo" == "cloudstream" ] || [ "$repo" == "revenge-xposed" ] || [ "$repo" == "io.github.vvb2060.callrecording" ] || [ "$owner" == "Droid-ify" ] || [ "$repo" == "Obtainium" ] || [ "$repo" == "Metrolist" ] || [ "$repo" == "Acode" ] || [ "$repo" == "PrivateDNSAndroid" ] || [ "$repo" == "RecordYou" ] || [ "$repo" == "android-appcachecleaner" ] || [ "$repo" == "com.wizpizz.reddidnt" ] || [ "$repo" == "cromite" ] || [ "$repo" == "nextdnsmanager" ] || [ "$repo" == "AmazeFileManager" ] || [ "$repo" == "MicroG-RE" ] || [ "$repo" == "dev.fzer0x.fucksolidexplorer" ] || [ "$repo" == "SilentRAR" ] || [ "$repo" == "TeleVip-Lsposed" ]; then
      if [ "$fileName" != "$fileBaseName" ]; then
        ...
        [[ ( "$repo" == "revenge-xposed" || "$repo" == "io.github.vvb2060.callrecording" || "$repo" == "com.wizpizz.reddidnt" || "$repo" == "MicroG-RE" || "$repo" == "dev.fzer0x.fucksolidexplorer" || "$repo" == "SilentRAR" || "$repo" == "TeleVip-Lsposed" ) ]] && dlUrl="https://github.com/$owner/$repo/releases/download/${latestReleases}/$assetsName" || dlUrl="https://github.com/$owner/$repo/releases/download/v${latestReleases}/$assetsName"
