...
updates() {
  ...
  [ $isAndroid == true ] && { curl -sL -o "$simplifyNext/apkInstall.sh" "https://raw.githubusercontent.com/arghya339/Simplify/refs/heads/main/Termux/apkInstall.sh" && source $simplifyNext/apkInstall.sh; }
  for ((c=0; c<${#scripts[@]}; c++)); do
    script="${scripts[c]}"
